...
def narrative_spec() -> dict:
    return {
        ...
        "cinematic": {"profile": "narrative_film_frame", "shot_function": "reveal", "visible_event": "A ledger changes hands in the rain.", "relationship_pressure": "A guard blocks the exit.", "viewer_task": "See who holds the ledger.", "viewer_position": "Inside the archway.", "frozen_moment": "The ledger reaches both hands.", "posterization_guard": True},
