...
当前稳定版本为 [`v0.6.2`](https://github.com/papperrollinggery/Paperrolling-DIRcreative-SKILL/releases/tag/v0.6.2)，包含 v2 路由、动态专业视角、紧凑状态、拆分模型 Adapter、资产基础/压测/生产账本链路、Seedance 2.5 方法优先、面部/无头服装资产约束和 Specialist Exchange v2。
...
gh release download v0.6.2 \
  ...
  --pattern 'dircreative-0.6.2.tar.gz' \
  --pattern 'SHA256SUMS'
```
...
ARTIFACT="$(pwd)/dircreative-0.6.2.tar.gz"
