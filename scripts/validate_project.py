...
def validate_adco_native_integration_contract() -> None:
    ...
    per_surface_terms = {
        ...
        "thread protocol": (
            thread_text,
            ["Orchestrated Worker Boundary", "adco.specialist-exchange", "nested_dispatch_allowed: false"],
        ),
        "README": (
            readme_text,
            [
...
def validate_thread_orchestration_protocol() -> None:
    ...
    required_terms = [
        ...
        "Dispatch Checklist",
        "Cleanup Checklist",
        "Keep one pinned main-controller thread",
        ...
        "archive completed, failed, duplicate, and superseded workers",
        "reconciled into repository files",
        ".dircreative/runs/",
        "skill_run_receipt",
        ...
        "thread-orchestration-protocol.md",
        "Substantive production work, implementation, document changes, and professional role execution default to worker Threads",
