...
def main() -> int:
    ...
    humanized_copy_wiring = "\n".join(
        [
            ...
            read("skills/dircreative/references/humanization-workflow.md"),
    ...
    add_check(
        ...
        lambda: require_terms(
            ...
            [
                ...
                "humanizer-zh",
                "shuorenhua",
                "humanization-workflow.md",
                "Sepia owns document-scale layered diagnosis",
                "review cannot silently become a",
                "full rewrite cannot start without actual source text",
    ...
    add_check(
        ...
        lambda: require_terms(
            ...
            [
                ...
                "no rewrite pass is repeated by a validator",
                "Diagnose architecture/domain, discourse and surface separately",
                "content-addressed preservation set",
